...
public class OurColors {
	    // 선택된 버튼 배경색 (초록)
	    public static final Color SELECTED = new Color(152, 251, 152);
	    ...
	    // 다음화면으로 가는 버튼 배경색 (주황)
	    public static final Color NEXT_BUTTON = new Color(255, 140, 60);
	    
	    // 이전화면으로 가는 버튼 배경색 (주황)
	    public static final Color PREVIOUS_BUTTON = new Color(168, 80, 35);
