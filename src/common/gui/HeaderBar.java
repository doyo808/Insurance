...
//		setPreferredSize(new Dimension(0, 200)); // 높이 고정, 너비는 프레임에 맞춤
		...
		CardSwitchButton 보험상품조회버튼 = new CardSwitchButton("보험상품조회", parentCardPanel, "보험상품조회", 150, 60); // 보험상품조회메인패널 이름 필요
		CardSwitchButton 보험상품가입버튼 = new CardSwitchButton("보험상품가입", parentCardPanel, "보험상품가입", 150, 60); // 보험상품가입메인패널 이름 필요
		CardSwitchButton 보험금청구버튼 = new CardSwitchButton("보험금청구", parentCardPanel, "보험금청구", 150, 60);
		CardSwitchButton 보험금납부버튼 = new CardSwitchButton("보험금납부", parentCardPanel, "보험금납부", 150, 60); // 보험금납부메인패널 이름 필요
		CardSwitchButton 마이페이지버튼 = new CardSwitchButton("마이페이지", parentCardPanel, "마이페이지", 150, 60); // 마이페이지메인패널 이름 필요
